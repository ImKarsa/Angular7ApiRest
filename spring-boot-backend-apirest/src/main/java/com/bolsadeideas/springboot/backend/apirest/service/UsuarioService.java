...
public class UsuarioService implements IUsuarioService,UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(usuario == null){
            logger.error("Error en el loggin: no exixte el usuario '"+ username +"' en el sistema!");
            throw new UsernameNotFoundException("Error en el loggin: no exixte el usuario '"+ username +"' en el sistema!");
        }
